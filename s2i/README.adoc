...
----
oc new-app --loglevel=6 gradle-container~https://github.com/marcredhat/guide-gradle-intro~https://github.com/OpenLiberty/guide-gradle-intro.git --context-dir=finish
----


----
....
[UILDER-INFO] Installing application source...
[BUILDER-INFO] gradle build detected
[BUILDER-INFO] gradle build
